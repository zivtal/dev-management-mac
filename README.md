...
```text
~/Library/Application Support/DevReinstaller/state.json
```
...
├── DevReinstaller.xcodeproj/   # Generated by XcodeGen
├── Sources/
...
```sh
xcodebuild \
  -project DevReinstaller.xcodeproj \
